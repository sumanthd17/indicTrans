...
langs=(bn hi gu kn ml mr or pa ta te)
...
for lang in ${langs[@]};do
	...
	# train preprocessing
	train_infname_src=$exp_dir/train/en-${lang}/train.$src_lang
	train_infname_tgt=$exp_dir/train/en-${lang}/train.$tgt_lang
	...
	# dev preprocessing
	dev_infname_src=$exp_dir/dev/dev.$src_lang
	dev_infname_tgt=$exp_dir/dev/dev.$tgt_lang
	...
	# test preprocessing
	test_infname_src=$exp_dir/test/test.$src_lang
	test_infname_tgt=$exp_dir/test/test.$tgt_lang
